...
with open(path1+"BD_name/"+"bd_all_shorter.txt","r",encoding="utf-8") as file1:
    # D 为所有出生缺陷疾病的列表
...
with open( output_path + "DS_G_ID_Sentence_2016.txt","a",encoding="utf-8") as output:
    for file in files:
        print(file)
            ...
            if status:
                ...
                for line in lines:  # 对于文章中的每一句话
                    ...
                    for disease in appear_D:  # 判断D - M 是否在这句话中共现
                        if disease[1] in list_line_lower:
